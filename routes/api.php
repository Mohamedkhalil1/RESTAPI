...
Route::resource('products.buyer.transaction', 'Product\ProductBuyerTransactionController',['only' => ['store']]);
/**
 * Transaction
*/
...
Route::get('users/verify/{code}','User\UserController@verify')->name('verify');
